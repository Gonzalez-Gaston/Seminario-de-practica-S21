...
CREATE TABLE `usuarios` (
  ...
  `tipo_usuario` enum('admin','personal','cliente') NOT NULL,
...
INSERT INTO `usuarios` VALUES (2,'Carlos','Pérez','carlos@example.com','password','personal'),(3,'María','Gómez','maria@example.com','password','cliente');
